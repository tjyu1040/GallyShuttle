...
/**
 * List deserializer for schedules.
 */
public class ListSchedulesDeserializer implements JsonDeserializer<List<Schedule>> {

    private final Type listType = new TypeToken<List<Schedule>>() {}.getType();
