...
package com.ephemeraldreams.gallyshuttle.api.models;
...
public class Entry {
    ...
    public StationTime noMaGallaudetStationTime;

    @Expose @SerializedName("gsx$unionstation")
    public StationTime unionStationTime;

    @Expose @SerializedName("gsx$mssd")
    public StationTime mssdStationTime;

    @Expose @SerializedName("gsx$kdes")
    public StationTime kdesStationTime;

    @Expose @SerializedName("gsx$benson")
    public StationTime bensonStationTime;

    @Expose @SerializedName("gsx$kellogg")
    public StationTime kelloggStationTime;
