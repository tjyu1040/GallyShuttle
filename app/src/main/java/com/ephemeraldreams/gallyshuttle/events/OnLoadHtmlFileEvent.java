 ...
 * String. This event passes along the resulting String to {@link com.ephemeraldreams.gallyshuttle.ui.AboutDialogFragment},
 * or {@link com.ephemeraldreams.gallyshuttle.ui.PoliciesFragment}.
 */
public class OnLoadHtmlFileEvent {

    public String html;

    public OnLoadHtmlFileEvent(String html) {
        this.html = html;
    }
}